/**
 * Regenerates `src/glyphs.ts` from the icon set in `../icons_v3/icons/`.
 *
...
import { ANATOMY, ANATOMY_KEYS, type AnatomyKey } from "../src/anatomy.ts";

const HERE = fileURLToPath(new URL(".", import.meta.url));
const ICONS_DIR = join(HERE, "..", "..", "icons_v3", "icons");
const OUT = join(HERE, "..", "src", "glyphs.ts");
